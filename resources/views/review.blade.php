        ...
        <div class=" mx-auto flex flex-wrap h-full">
          ...
          <form action="" method="post" class="">
            ...
            <div class="container mt-auto lg:w-1/2 w-full lg:mt-20  bg-blue-600 rounded-xl font-mono overflow-hidden relative h-1/2 ">
              ...
              <div class="">
                <h2 class="text-white text-3xl font-bold my-6 text-center">ご来店ありがとうございました</h2>
                <h3 class="text-white text-2xl font-bold text-center">サービスはいかがでしたか？</h3>
                <h4 class="text-white text-xl font-bold text-center">よろしければ、ご感想をお聞かせください</h4>
